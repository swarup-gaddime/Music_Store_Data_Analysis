...
Write a query to return the email, first name, last name, & Genre of all Rock Music listeners. Return you list ordered alphabetically by email starting with alter
